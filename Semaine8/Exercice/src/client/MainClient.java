		...
		try {
			...
			while (fichier.hasNextLine()) {
				try {
					...
					Generateur g= new AmExGenerateur(new DinersClubGenerateur(new DiscoverGenerateur(new MasterCardGenerateur( new VisaGenerateur(null))))) ;
					CarteDeCredit carteDeCredit = g.creerCarte(parts[0], dateExpiration, parts[2]);
