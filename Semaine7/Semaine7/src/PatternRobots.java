public class PatternRobots {
	...
	public static void main(String[] args) {
		Robot robot1=new BuilderRobots().setCanon(1).build();// un robot avec un canon de 10, un bouclier de 2, une fréquence de tir de 100 et qui a reçu une amélioration de canon multipliant la puissance de ce dernier par 2.
		Robot robot2=new BuilderRobots().setFreq(3).build();// un robot avec un canon de 9, un bouclier de 3, une fréquence de tir de 90
